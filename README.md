...
```bash
curl -fsSL https://raw.githubusercontent.com/mubaiqq/dyjx/v1.0.1/deploy.sh | sudo bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/mubaiqq/dyjx/v1.0.1/deploy.sh \
